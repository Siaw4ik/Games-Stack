# RS Clone - ***Games-Stack***  
  ...
  - Для запуска Unit тестов проверяющему требуется клонировать репозиторий (выполнить в консоле nmp install установки зависимостей) и запустить тесты командой ***npm run tests*** 
